...
public class WeatherDataService {
    ...
    public interface ForeCastByIDRepsonse {
        void onError(String message);

        void onResponse(List<WeatherReportModel> weatherReportModels);
    }

    public void getCityForecastByID(String cityID, ForeCastByIDRepsonse foreCastByIDRepsonse){
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i<consolidated_weather_list.length(); i++) {
                        ...
                        one_day_weather.setGetWeather_state_abbr(first_day_from_api.getString("weather_state_abbr"));
                    ...
                    foreCastByIDRepsonse.onResponse(weatherReportModels) ;
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //get the consolodatred weather


                //get each item isn the array and assign to the watherreportmodel object
    ...
    public void getCityForecastByName(String cityName,GetCityForecastByNameCallBack getCityForecastByNameCallBack){
        ...
        getCityID(cityName, new VolleyResponseListener() {
            ...
            public void onResponse(String cityID) {
                ...
                getCityForecastByID(cityID, new ForeCastByIDRepsonse() {
                    @Override
                    public void onError(String message) {
